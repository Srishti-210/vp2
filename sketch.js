...
var foodobject
var Feedtime
var Lastfeed, foodStockImg, fs,foodStockImg2,fs2;
...

{
  ...
  foodStockImg = loadImage("bones.jpg")
  foodStockImg2=loadImage("food.jpg")
  //load images here
...
function setup() {
  ...
  foodobject=new Food()
  dog = createSprite(550,100,10,10);
 ...
 // fs2 = createSprite(178, 50, 20, 20);
 // fs2.addImage(foodStockImg2);
 // fs2.scale = 0.07
 
  var dogo = database.ref('Food');
  dogo.on("value", readPosition, showError);
  feed = createButton("Feed Brownie!")
